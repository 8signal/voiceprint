...
- "I'm a closet integrator and I didn't know it had a name."
- "I need someone in the seat next to me who can run the business."
- "We've got the visionary thing down. We don't have the second-in-command."

**What they say after working with you:**
- "I got my time back."
- "We have the right person, in the right seat."
- "We finally have a foundation."
- "He's been there. He knows the way."
...
### Pillar 4: Punchy Then Conversational
Mixes short statements (30% of LinkedIn sentences are ≤6 words) with longer explanatory ones. Bold, short statement → context or story.
- **Sounds like:** "The 10x path is uncomfortable. Most founders won't take it. Here's why I think the ones who do have a thing in common..."
...
### Pillar 6: Vulnerability Lets the Coach In
Podcast voice includes specific moments of honesty: "I was a closet integrator before I knew what it was." These make the authority feel real, not performed.
- **Sounds like:** "Look, I've been on the wrong side of that decision. Cost me a relationship and a year of progress. Here's what I learned."
- **Does NOT sound like:** "In my extensive 27 years of experience, I have never made a mistake of that nature."
...
- Sarcasm or irony.
- TED-talk cadence (too polished, too parallel).

---

## 7. Content themes

### Theme 1: The Closet Integrator
**Why he has a take:** It's his origin story. "I was a closet integrator before I knew what it was."
**Sample angles:** Naming the pattern. Founders doing two jobs without realizing it. The cost of the closet integrator role on the visionary's marriage, health, and business.

### Theme 2: Right Person, Right Seat
**Why he has a take:** Core to how he works with leadership teams.
**Sample angles:** Putting names on the chart. The quarterly evaluation. Why keeping someone in the wrong seat delays *their* opportunity, not just yours.

### Theme 3: Building the Foundation
**Why he has a take:** "Building the foundation for sustainable growth" is recurring language across his content.
...
**Why he has a take:** Native EOS language. He IS the integrator, fractionally.
**Sample angles:** Loneliness of the visionary. Why visionaries hire integrators too late. The difference between an integrator and an operations manager.

### Theme 6: Walking the Path
**Why he has a take:** 27+ years of leadership, 6+ years as an integrator. "We have walked the path and know the way."
**Sample angles:** What he's seen work, what he's seen fail. Specific companies, specific decisions, specific outcomes (anonymized).
...
**Never use:**
- #Hustle #GrindMode #Motivation #Blessed #BossLife #ThoughtLeader
