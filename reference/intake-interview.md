...
The model will read your answers and generate a populated `identity.md` for you. You can also use the intake site at [voiceprint-app.vercel.app](https://voiceprint-app.vercel.app) which walks you through the same questions and gives you a downloadable file.
...
Pull from real conversations if you can. Verbatim phrases.

**5. What do they say after you've worked with them for 6 months?**
Real testimonial language if you have it. If you don't, what would you want them to say?
...
**9. Name 3-5 client moments that capture what your work actually feels like.**
Specific stories. Not generalizations. ("A CEO at a $25M staffing firm told me he was about to fire his most profitable client because the guy was annoying. I made him run the numbers first.")
...
**18. What artifacts do you produce regularly that we can pull from?**
Check all that apply: meeting transcripts (Fireflies/Otter/Zoom), V/TO, weekly reviews, client wins log, Slack threads, journal entries, team retros. Where do they live?
...
The model will produce a populated identity file. Save it to your project folder. Update it as your voice sharpens.

If you used the intake site, just download the file and drop it in.
